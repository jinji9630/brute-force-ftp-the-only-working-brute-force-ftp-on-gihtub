...
def run_tests(servers, usernames, passwords, max_threads):
    threads = []
    for ip, port in servers:
        ...
        thread = threading.Thread(target=test_login, args=(ip, port, usernames, passwords))
...
run_tests(servers, usernames, passwords, max_threads)
